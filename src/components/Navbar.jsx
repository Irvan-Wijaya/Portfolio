...
import logos from '../assets/webIcon.png'
    ...
    >
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        onClick={() =>{
          ...
          <p className='text-white text-[18px] font-bold cursor-pointer flex'>Irvan &nbsp;<span className='sm:block hidden'>| App Developer</span></p>
        </Link>
